...
import { uploadFile } from "../../../utils/supabase";// Mengimpor fungsi handleFileUpload
...
const Create = () => {
  ...
  const [fileElektronik, setFileElektronik] = useState(null);  // Menyimpan file yang diupload
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-50 py-6">
      <form
      ...
      >
        ...
        <div className="mt-6 text-center">
          <button
            type="submit"
            className="w-full py-3 px-6 text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-300"
          >
            Simpan
          </button>
        </div>
